...
public class BattleRunner : MonoBehaviour
{
    ...
    /// <summary>
    /// Resolve one exchange without requiring a BattleRunner scene instance.
    ...
    /// </summary>
    public static string ResolveCombat(Unit attacker, Unit defender, bool useSpecial = false)
    {
